...
import edu.cmu.cs211.chess.evaluation.MyEvaluator;
import edu.cmu.cs211.chess.search.MySearcher;
import edu.cmu.cs211.chess.search.MyTimer;
...
public class Engine
{
	...
	private Searcher <ArrayMove,ArrayBoard>
		searcher = new MySearcher<ArrayMove,ArrayBoard>();
	
	private MyEvaluator eval = new MyEvaluator();
	...
	{
		searcher.setTimer(new MyTimer(time,inc));
		searcher.setMaxDepth(8);
		searcher.setMinDepth(1); // DO NOT CHANGE
